...
//  DynamicPriceIsland
//
//  Created by Ho Si Tuan on 26/08/2024.
//
...
public struct AsyncSVGImage<Content, Placeholder>: View where Content: View, Placeholder: View {
    ...
    private let uiImageResult: (UIImage?) -> Void
    ...
    public init(url: URL?, uiImageResult: @escaping (UIImage?) -> Void, @ViewBuilder content: @escaping (Image) -> Content, @ViewBuilder placeholder: @escaping () -> Placeholder) {
        self.url = url
        self.content = content
        self.placeholder = placeholder()
        self.uiImageResult = uiImageResult
    }
